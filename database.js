...
const db = new sqlite3.Database('./superology.sqlite3', sqlite3.OPEN_READWRITE , err => {
    if (err)
        return console.error(err.message)
    console.log("[Database] > Connected to SQLite Database")
})
// db.run('CREATE TABLE "users" ("id" INTEGER NOT NULL UNIQUE, "username" TEXT, "firstname" TEXT, "lastname" TEXT, "user_id" NUMERIC NOT NULL UNIQUE, PRIMARY KEY("id" AUTOINCREMENT))')
